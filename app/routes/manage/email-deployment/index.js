...
import query from 'fortnight/gql/queries/email-deployment/all';
import search from 'fortnight/gql/queries/email-deployment/search';
...
export default Route.extend(RouteQueryManager, {
  ...
  search(phrase, pagination) {
    ...
    const resultKey = 'searchEmailDeployments';
  ...
  model({ first, after, sortBy, ascending, phrase }) {
    ...
    const resultKey = 'allEmailDeployments';
    controller.set('resultKey', resultKey);
