...
import query from 'fortnight/gql/queries/email-deployment/edit/placements';
...
export default Route.extend(RouteQueryManager, {
  ...
  model({ first, sortBy, ascending }) {
    ...
    const id = this.modelFor('manage.email-deployment.edit').get('id');
    const input = { id };
    ...
    const resultKey = 'emailDeployment';
